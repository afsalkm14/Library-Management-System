...
<div class="panel panel-purple">
                                <div class="panel-heading">
                                    <h2 class="panel-title">Number of Books</h2>
                                </div>
                                <div class="panel-body">
                                    <h1><?php
                                    $sql="select count(ISBN) as total from books_info";
...
<div class="panel panel-red">
                                ...
                                <div class="panel-body">
                                  <h1><?php
                                  $sql="select SUM(QTY) as total from books_info";
                                  $result=mysqli_query($db,$sql);
                                  $data=mysqli_fetch_assoc($result);
                                  echo $data['total'];
...
<div class="panel panel-green">
                                <div class="panel-heading">
                                    <h3 class="panel-title">No of Students</h3>
                                </div>
                                <div class="panel-body">
                                  <h1><?php
                                  $sql="select count(RNO) as total from students_info";
                                  $result=mysqli_query($db,$sql);
                                  $data=mysqli_fetch_assoc($result);
                                  echo $data['total'];
...
<div class="panel panel-yellow">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Total Fine Balance to be Collected</h3>
                                </div>
                                <div class="panel-body">
                                  <h1><?php
                                  $sql="select SUM(FINE) as total from students_info";
                                  $result=mysqli_query($db,$sql);
                                  $data=mysqli_fetch_assoc($result);
                                  echo $data['total'];
