        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
              <div class="page-title">
                                  <h3 class="breadcrumb-header">Fine Collection</h3>
                                  <div class="page-breadcrumb">
                                      <ol class="breadcrumb breadcrumb-with-header">
                                          <li><a>Amount</a></li>
                                          <li><a href="#">Collected Now</a></li>
...
<form action="TR_CollectFine.php" method="post">
  ...
  <div class="form-group">
    <label for="">
    Enter Amount</label>
     <input type="number" class="form-control" name="amount" size="50" required>
  </div>
