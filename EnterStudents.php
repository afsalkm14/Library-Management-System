        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
              <div class="page-title">
                                  <h3 class="breadcrumb-header">Add New Student</h3>
                                  <div class="page-breadcrumb">
                                      <ol class="breadcrumb breadcrumb-with-header">
                                          <li>Student Deatils</a></li>
...
<!-- Page Content Starts -->
                <div id="main-wrapper">
                    ...
                    Enter Register Number</label>
                     <input type="text" class="form-control" name="RNO" size="50" required>
                    </div>
                    ...
                    <label for="">
                    Enter Name</label>
                      <input type="text" class="form-control" name="SNAME" size="50" required>
                    </div>

                    <div class="form-group">
                    <label for="">
                    Enter Department</label>
                       <input type="text" class="form-control" name="DEPT" size="50" required>
                    </div>

                    <div class="form-group">
                    <label for="">
                    Enter Semester</label>
                       <input type="text" class="form-control" name="SEMESTER" size="50" required>
                    </div>
